...
init_test_dir
"$root_path"/target/release/typac react 2>&1 | tee "$temp_app_path"/log.txt
...
init_test_dir
touch yarn.lock
"$root_path"/target/release/typac @babel/core @babel/code-frame 2>&1 | tee "$temp_app_path"/log.txt
